...
#' @param coefficients Logical scalar indicating whether to print the model fit coefficients. The default is \code{FALSE}.
...
print.gformula_survival <- function(x, coefficients = FALSE, rmses = FALSE,
                                    hazardratio = FALSE, ...) {
  ...
  cat(x$header, '\n\n')
  print(x$result[t == 0 | t == max(t)], row.names = FALSE, col.names='top')
...
print.gformula_continuous_eof <- function(x, coefficients = FALSE,
  ...
  cat(x$header, '\n\n')
  print(x$result[t == max(t)], row.names = FALSE, col.names='top')
...
print.gformula_binary_eof <- function(x, coefficients = FALSE, rmses = FALSE,
                                      ...) {
...
#' @param survival Logical scalar indicating whether to include a plot for the survival. The default is \code{TRUE}.
...
plot.gformula_survival <- function(x, covnames = NULL, risk = TRUE,
                                   survival= TRUE, ncol = NULL, nrow = NULL,
