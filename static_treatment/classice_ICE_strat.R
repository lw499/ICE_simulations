...
myfunc = function(m)
{
  ...
  y5dat = tmpdata[!is.na(tmpdata$C_5) & tmpdata$C_5==0 & 
                    tmpdata$A_0==abar & tmpdata$A_1==abar &  
                    tmpdata$A_2==abar &  tmpdata$A_3==abar &  
                    tmpdata$A_4==abar]; 
  y5fit = glm(Y_5 ~ L1_4, family = binomial(), data = y5dat) ; 
  ...
  y5dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==abar,]; 
  y5dat$y5pred = predict(y5fit, newdata = y5dat, type="response"); 
  ...
  y4dat = tmpdata[!is.na(tmpdata$C_4) & tmpdata$C_4==0 &
                    tmpdata$A_0==abar & tmpdata$A_1==abar &  
                    tmpdata$A_2==abar &  tmpdata$A_3==abar]; 
  y4fit = glm(Y_4 ~ L1_3, family = binomial(), data = y4dat) ; 
  ...
  y4dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==abar,]; 
  y4dat$y4pred = predict(y4fit, newdata = y4dat, type="response"); 
  ...
  y3dat = tmpdata[!is.na(tmpdata$C_3) & tmpdata$C_3==0 & 
                    tmpdata$A_0==abar & tmpdata$A_1==abar &  
                    tmpdata$A_2==abar]; 
  y3fit = glm(Y_3 ~ L1_2, family = binomial(), data = y3dat) ; 
  ...
  y3dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==abar,]; 
  y3dat$y3pred = predict(y3fit, newdata = y3dat, type="response"); 
  ...
  y2dat = tmpdata[!is.na(tmpdata$C_2) & tmpdata$C_2==0 &
                    tmpdata$A_0==abar & tmpdata$A_1==abar]; 
  y2fit = glm(Y_2 ~ L1_1, family = binomial(), data = y2dat) ; 
  y2dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==abar,]; 
  ...
  ######time 1######
  ##################
  y1dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==abar,]; 
  y1fit = glm(Y_1 ~ L1_0, family = binomial(), data = y1dat) ; 
  y1dat = tmpdata; 
  y1dat$y1pred = predict(y1fit, newdata = y1dat, type="response"); 
...
write.csv(test2,"classic_ICE_strat.csv")
