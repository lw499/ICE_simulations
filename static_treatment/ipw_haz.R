...
myfunc = function(m)
{
  ...
  mean = NULL
    ind = NA;
    #time 1
    tmp = tmpdata[tmpdata$A_0==1 & tmpdata$C_1==0,]
    fit1 = glm(Y_1 ~ 1, family = binomial(), data = tmp, weights = 1/(pi0*pi0c))
    param1 = plogis(summary(fit1)$coef[1,1])
    #time 2
    tmp  = tmpdata[tmpdata$A_0==1 &tmpdata$A_1==1 & tmpdata$Y_1==0 & tmpdata$C_2==0 & !is.na(tmpdata$C_2),]
    fit2 = glm(Y_2 ~ 1, family = binomial(), data = tmp, weights = 1/(pi1*pi1c))
    param2 = plogis(summary(fit2)$coef[1,1])
    #time 3
    tmp  = tmpdata[tmpdata$A_0==1 &tmpdata$A_1==1 & tmpdata$A_2==1 & tmpdata$Y_2==0 & tmpdata$C_3==0 & !is.na(tmpdata$C_3),]
    ...
    #time 4
    tmp  = tmpdata[tmpdata$A_0==1 &tmpdata$A_1==1 & tmpdata$A_2==1 & tmpdata$A_3==1 & tmpdata$Y_3==0 & tmpdata$C_4==0 & !is.na(tmpdata$C_4),]
    ...
    #time 5
    tmp  = tmpdata[tmpdata$A_0==1 &tmpdata$A_1==1 & tmpdata$A_2==1 & tmpdata$A_3==1 & tmpdata$A_4==1 & tmpdata$Y_4==0 & tmpdata$C_5==0 & !is.na(tmpdata$C_5),]
