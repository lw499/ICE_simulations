...
myfunc = function(m)
{
  ...
  ######time 5######
  ##################
    y5dat = tmpdata[!is.na(tmpdata$C_4) & tmpdata$C_4==0,]; y5dat$A_4 = y5dat$L1_4;
  ...
  ######time 4######
  ##################
    y4dat = tmpdata[!is.na(tmpdata$C_3) & tmpdata$C_3==0,]; y4dat$A_3 = y4dat$L1_3;
  ...
  ######time 3######
  ##################
    y3dat = tmpdata[!is.na(tmpdata$C_2) & tmpdata$C_2==0,]; y3dat$A_2 = y3dat$L1_2;
  ...
  ######time 2######
  ##################
    y2dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0,]; y2dat$A_1 = y2dat$L1_1;
  ...
  ######time 1######
  ##################
    y1dat = tmpdata; y1dat$A_0 = y1dat$L1_0;
