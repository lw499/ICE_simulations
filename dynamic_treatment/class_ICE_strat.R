...
myfunc = function(m)
{
  ...
  y5dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  y5dat$y5pred = predict(y5fit, newdata = y5dat, type="response"); 
  ...
  y4dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  y4dat$y4pred = predict(y4fit, newdata = y4dat, type="response"); 
  ...
  y3dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  y3dat$y3pred = predict(y3fit, newdata = y3dat, type="response"); 
  ...
  y2dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
...
write.csv(test2,"class_ICE_strat.csv")
