...
myfunc = function(m)
{
  ...
  ind = NA;
  #time 1
  tmp = tmpdata[tmpdata$A_0==tmpdata$L1_0 & tmpdata$C_1==0,]
  ...
  #time 2
  tmp  = tmpdata[tmpdata$A_0==tmpdata$L1_0 & tmpdata$A_1==tmpdata$L1_1 & tmpdata$Y_1==0 & tmpdata$C_2==0,]
  ...
  #time 3
  tmp  = tmpdata[tmpdata$A_0==tmpdata$L1_0 & tmpdata$A_1==tmpdata$L1_1 & tmpdata$A_2==tmpdata$L1_2 & tmpdata$Y_2==0 & tmpdata$C_3==0,]
  ...
  #time 4
  tmp  = tmpdata[tmpdata$A_0==tmpdata$L1_0 & tmpdata$A_1==tmpdata$L1_1 & tmpdata$A_2==tmpdata$L1_2 & tmpdata$A_3==tmpdata$L1_3 & tmpdata$Y_3==0 & tmpdata$C_4==0,]
  ...
  #time 5
  tmp  = tmpdata[tmpdata$A_0==tmpdata$L1_0 & tmpdata$A_1==tmpdata$L1_1 & tmpdata$A_2==tmpdata$L1_2 & tmpdata$A_3==tmpdata$L1_3 & tmpdata$A_4==tmpdata$L1_4 & tmpdata$Y_4==0 & tmpdata$C_5==0,]
