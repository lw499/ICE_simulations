...
myfunc = function(m)
{
  ...
  y5dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$Y_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  ...
  y4dat =  tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$Y_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  ...
  y3dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$Y_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
  ...
  ######time 2######
  ##################
  y2dat = tmpdata[!is.na(tmpdata$C_1) & tmpdata$C_1==0 & tmpdata$Y_1==0 & tmpdata$A_0==tmpdata$L1_0,]; 
