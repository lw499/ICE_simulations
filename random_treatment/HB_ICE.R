...
##################
  ...
  y5dat = tmpdata ; y5dat$A_0 = ifelse(y5dat$L1_0==0,0,y5dat$A_0)
...
##################
  ...
  y4dat = tmpdata; y4dat$A_0 = ifelse(y4dat$L1_0==0,0,y4dat$A_0)
...
##################
  ...
  y3dat = tmpdata; y3dat$A_0 = ifelse(y3dat$L1_0==0,0,y3dat$A_0)
...
##################
  ...
  y2dat = tmpdata; y2dat$A_0 = ifelse(y2dat$L1_0==0,0,y2dat$A_0);
...
######time 1######
##################
  y1dat = tmpdata; y1dat$A_0 = ifelse(y1dat$L1_0==0,0,y1dat$A_0);
